...
<p>&nbsp;</p>
<p>The appearance of the language selector can be changed by setting values in the layout section.</p>
<blockquote>
    <p>"layout": {<br /> "lang_layout": "select",<br /> "lang_flags_dir": "4x3"<br /> },</p>
</blockquote>
<p>Available modes <strong>lang_layout</strong></p>
<ul>
    <li><strong>flags-select</strong> – a drop-down selector with language names and flags,</li>
    <li><strong>flags-only-select</strong> – a drop-down selector with flags only (no text),</li>
    <li><strong>flags-list</strong> – a list of flags displayed side by side (no text),</li>
    <li><strong>select</strong> – a classic drop-down selector with language names (no flags),</li>
</ul>
<p>Flag directory <strong>lang_flags_dir</strong></p>
<ul>
    <li><strong>4x3</strong> – a 4:3 flag aspect ratio (standard rectangular),</li>
    <li><strong>1x1</strong> – a square flag aspect ratio,</li>
</ul>
<p>&nbsp;</p>
...
<ul>
    ...
    <li>The language selector layout has been modified.</li>
</ul>
<p>&nbsp;</p>
